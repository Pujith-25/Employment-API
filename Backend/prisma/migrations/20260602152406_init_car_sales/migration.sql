...
CREATE TABLE "CustomerService" (
    ...
    CONSTRAINT "CustomerService_pkey" PRIMARY KEY ("customerId","carId")
);
...
-- AddForeignKey
ALTER TABLE "CustomerService" ADD CONSTRAINT "CustomerService_carId_fkey" FOREIGN KEY ("carId") REFERENCES "Car"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
